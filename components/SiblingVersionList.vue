  ...
  <div class="version-list relative" v-bind:class="{'clipped': !showingAllBuildpacks}">
    <ul class="list f5 pl0 mv0">
      <li v-for="(version, index) in versions">
        <nuxt-link :to="{ name: 'buildpacks-id-version', params: { id: id, version: version } }" class="link blue dim lh-title fw6 db pv2 bb b--black-10 o-50 flex items-center justify-between">
          {{ version }}
